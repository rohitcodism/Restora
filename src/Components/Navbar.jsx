    ...
    return(
        <Container sx={{mt : "15px" , display: "flex", justifyContent: "space-evenly", width: "100vw", alignItems : "center"}}>
            ...
            <Container sx={{ display : "flex", alignItems : "center"}}>
                <Link to="/menu" style={{textDecoration : "none"}}><Typography variant="h6" sx={{fontWeight : "regular", mr : "5rem", color : "#000000", "&:hover":{color:"#01D28E"}}}>Menu</Typography></Link>
                <Link to="/order" style={{textDecoration: "none"}}><Typography variant="h6" sx={{fontWeight : "regular", mr : "5rem", color : "#000000", "&:hover":{color:"#01D28E"}}}>Order</Typography></Link>
                <Link to="/cart" style={{textDecoration: "none"}}><Typography variant="h6" sx={{fontWeight : "regular", mr : "5rem", color : "#000000", "&:hover":{color:"#01D28E"}}}>Cart</Typography></Link>
            </Container>
