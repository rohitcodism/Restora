...
export const Hero = () => {
    ...
    return(
        <Container sx={{display : "flex", flexDirection : "column", alignItems : "center", alignContent : "center", mt : "10rem", height : "100%"}}>
            <Typography variant="h3" sx={{fontFamily: "Poppins, sans-serif", fontWeight : "bold", textAlign : "center"}}>Explore the world of<span style={{color : "#01D28E", fontFamily : "Caveat, cursive", fontWeight : "SemiBold", fontSize : "4rem", paddingLeft : "1rem"}}>flavors . . </span></Typography>
